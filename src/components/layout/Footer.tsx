...
const Footer = () => {
  ...
  return (
    <footer className={`hidden  bg-muted z-100 border-t ${location.pathname == '/employer-dashboard' ? 'hidden  ' : location.pathname.split('/')[1] == 'employer-dashboard' ? "hidden":location.pathname.split('/')[1] == 'add-job' ? "hidden"  :location.pathname.split('/')[1] =='auth' ? 'auth' : 'md:block'}`}>
      <div className="container mx-auto px-4 py-12">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2 text-sm text-muted-foreground">
                ...
                <span>yourcareercompanion@gmail.com</span>
              </div>
              <div className="flex items-center space-x-2 text-sm text-muted-foreground">
                <Phone className="h-4 w-4" />
                <span>+2376813942957</span>
              </div>
              <div className="flex items-center space-x-2 text-sm text-muted-foreground">
                <MapPin className="h-4 w-4" />
                <span>Mvan, Yaoundé</span>
              </div>
            </div>
        ...
        <div className="mt-8 pt-8 border-t border-border">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-muted-foreground">
              © {currentYear} Career Companion. All rights reserved.
            </p>
